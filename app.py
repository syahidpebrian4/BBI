...
# --- CUSTOM CSS (Fixed Header Logo & Layout Merah Elegan) ---
st.markdown(f"""
    <style>
    ...
    /* Fixed Header Bar Logo (Melayang di atas saat scroll) */
    ...
    /* Padding Atas Agar Konten Tidak Tertutup Header Logo */
    .block-container {{
